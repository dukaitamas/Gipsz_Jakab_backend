...
// Route::apiResource('ingatlanok', EstateController::class)->only(['index','show']);

Route::get('ingatlan', [EstateController::class, 'index']);
// vagy egyesével homom létre az utvonaélakat ez a get all   return Estate::all(); az estatecontroller.php-ből
